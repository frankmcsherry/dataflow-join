...
fn main () {
    ...
    timely::execute_from_args(std::env::args(), move |root| {
        ...
        let (mut input, probe, forward, reverse) = root.dataflow::<u32,_,_>(|builder| {
            ...
            let dK4dA1 = dG.extend(vec![Box::new(forward.extend_using(|&(a1,_a2)| a1, <_ as PartialOrd>::lt)),
            ...
            let dK4dB1 = dG.extend(vec![Box::new(forward.extend_using(|&(a1,_a3)| a1, <_ as PartialOrd>::le)),
            ...
            let dK4dC1 = dG.extend(vec![Box::new(forward.extend_using(|&(a1,_a4)| a1, <_ as PartialOrd>::le)),
            ...
            let dK4dD1 = dG.extend(vec![Box::new(reverse.extend_using(|&(a2,_a3)| a2, <_ as PartialOrd>::le)),
            ...
            let dK4dE1 = dG.extend(vec![Box::new(reverse.extend_using(|&(a2,_a4)| a2, <_ as PartialOrd>::le)),
            ...
            let dK4dF1 = dG.extend(vec![Box::new(reverse.extend_using(|&(a3,_a4)| a3, <_ as PartialOrd>::le)),
